...
public class okays {
    ...
    public static final String CORRIDA_RESERVADA = "CORRIDA RESERVADA";
    public static final String HISTORICO_ENCONTRADO = "HISTORICO ENCONTRADO";
    public static final String CORRIDA_CANCELADA = "CORRIDA CANCELADA";
}